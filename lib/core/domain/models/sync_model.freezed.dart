...
/// @nodoc
mixin _$SyncData {
  bool get syncInProcess => throw _privateConstructorUsedError;
...
class _$SyncDataCopyWithImpl<$Res, $Val extends SyncData>
  ...
  @override
  $Res call({
    Object? syncInProcess = null,
  }) {
    return _then(_value.copyWith(
      syncInProcess: null == syncInProcess
          ? _value.syncInProcess
          : syncInProcess // ignore: cast_nullable_to_non_nullable
              as bool,
    ) as $Val);
  }
}
...
class _$_SyncData extends _SyncData {
  const _$_SyncData({this.syncInProcess = false}) : super._();
  ...
  @override
  @JsonKey()
  final bool syncInProcess;

  @override
  String toString() {
    return 'SyncData(syncInProcess: $syncInProcess)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.syncInProcess, syncInProcess) ||
                other.syncInProcess == syncInProcess));
  }

  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, syncInProcess);
